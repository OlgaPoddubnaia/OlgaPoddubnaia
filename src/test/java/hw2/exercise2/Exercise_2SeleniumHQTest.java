...
public class Exercise_2SeleniumHQTest extends AbstractTests {
    ...
    public void selectDropdownYellow() {
        WebElement searchDropdown = driver.findElement(By.cssSelector("div.colors > select"));
        searchDropdown.click();
        WebElement yellow = driver.findElement(By.cssSelector("option:nth-child(4)"));
        yellow.click();
    ...
    public void softAsserts() {
        ...
        WebElement earthBox = driver.findElement(By.cssSelector(" label:nth-child(2) > input[type=checkbox]"));
        earthBox.click();
        softAssert.assertTrue(earthBox.isSelected());
        earthBox.click();
        softAssert.assertFalse(earthBox.isSelected());

        WebElement fireBox = driver.findElement(By.cssSelector("label:nth-child(4) > input[type=checkbox]"));
        fireBox.click();
        ...
        WebElement goldRadio = driver.findElement(By.cssSelector(" label:nth-child(1) > input[type=radio]"));
        softAssert.assertFalse(goldRadio.isSelected());
        goldRadio.click();
        softAssert.assertTrue(goldRadio.isSelected());

        WebElement silverRadio = driver.findElement(By.cssSelector("label:nth-child(2) > input[type=radio]"));
        softAssert.assertFalse(silverRadio.isSelected());
        silverRadio.click();
        softAssert.assertTrue(silverRadio.isSelected());

        WebElement bronzeRadio = driver.findElement(By.cssSelector("label:nth-child(3) > input[type=radio]"));
        ...
        softAssert.assertEquals((driver.findElement(By
                .cssSelector("div:nth-child(3) > label:nth-child(1)")).getText()), "Gold");

        softAssert.assertEquals((driver.findElement(By
                .cssSelector("div:nth-child(3) > label:nth-child(2)")).getText()), "Silver");

        softAssert.assertEquals((driver.findElement(By
                .cssSelector("div:nth-child(3) > label:nth-child(3)")).getText()), "Bronze");

        softAssert.assertEquals((driver.findElement(By
                .cssSelector("div:nth-child(3) > label:nth-child(4)")).getText()), "Selen");
        ...
        softAssert.assertEquals((driver.findElement(By.cssSelector("option:nth-child(4)"))
                .getText()), "Yellow");

        searchDropdown.click();
        WebElement red = driver.findElement(By.cssSelector("option:nth-child(1)"));
        red.click();
        softAssert.assertTrue(red.isSelected());
        softAssert.assertEquals((driver.findElement(By.cssSelector("option:nth-child(1)"))
                .getText()), "Red");

        searchDropdown.click();
        WebElement green = driver.findElement(By.cssSelector("option:nth-child(2)"));
        green.click();
        softAssert.assertTrue(green.isSelected());
        softAssert.assertEquals((driver.findElement(By.cssSelector("option:nth-child(2)"))
                .getText()), "Green");

        searchDropdown.click();
        WebElement blue = driver.findElement(By.cssSelector("option:nth-child(3)"));
        blue.click();
        softAssert.assertTrue(blue.isSelected());
        softAssert.assertEquals((driver.findElement(By.cssSelector("option:nth-child(3)"))
                .getText()), "Blue");
